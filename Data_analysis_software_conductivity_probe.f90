!  Data_analysis_software.f90 

!****************************************************************************
!
!  PROGRAM: Air-water-flow-data-analysis-software-for-double-tip-phase-detection-intrusive-probes
!
!  Version 2
...
program Data_analysis_software
...
implicit none
	...
	WRITE (*,*) '******************************************************************************'
	WRITE (*,*) 'Welcome to the Data Analyses software for double-tip conductivity probe signal!'
	WRITE (*,*) ' '
	WRITE (*,*) 'The software was developed by Stefan Felder between 2009-2018 -'
	WRITE (*,*) 'It is the intellectual property of Stefan Felder, who holds the copyright'
	WRITE (*,*) ' '
	WRITE (*,*) 'Thank you for acknowledging this!'
	WRITE (*,*) '******************************************************************************'
	WRITE (*,*) ' '
	WRITE (*,*) 'Let us start:'
...
END IF
	...
	PDF_segments = REAL(6.0)/PDF_V_segment_size		!Number of segments for PDF (segments between 0 and 5V)
...
INTEGER, PARAMETER :: DBL = SELECTED_REAL_KIND(p=15)	!Precision of the Real variables
	...
	PDF_upper_boundary_air = 4 / PDF_V_segment_size
